...
if(isset($_POST['submit']))
   {
    ...
    `RCBAL`='$rc',`ADDRESS`='$address',`STATE`='$state',`CITY`='$city'  WHERE ID = '$id'";
...
<div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Mobile Number"  value="<?php echo $row['MOBILE']  ?>"  name="mobile">
                  </div>  
<div class="form-group">
                    <label for="exampleInputEmail1">Email</label>
                    <input type="email" class="form-control " placeholder="Email ID"  value="<?php echo $row['EMAIL']  ?>"  name="email">
                  </div>                                    
                  <div class="row">
                  <div class="col-4">
                  <div class="form-group">
                    <label for="exampleInputEmail1">SMS Bal</label>
                    <input type="text" class="form-control" value="<?php echo $row['SMSBAL'] ?>" name="smsbal" readonly>
                  </div> 
                  </div>
                  <div class="col-4">
                  <div class="form-group">
                    <label for="exampleInputEmail1">RCH Bal</label>
                    <input type="text" class="form-control" value="<?php echo $row['RCBAL'] ?>" name="rcbal" readonly>
                  </div>
                  </div>
                  <div class="col-4">
                  <div class="form-group">
                    <label for="exampleInputEmail1">DMR Bal</label>
                    <input type="text" class="form-control" value="<?php echo $row['DMRBAL'] ?>" name="dmrbal" readonly>
                  </div>
                  </div>
                </div>                         
