                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!"> API Call Back</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-block">
                                            ...
                                            action="" >
                                                <div class="form-group row">
                                                    <div class="col-sm-4">
                                                        <label for="">API CallBack Name</label>
                                                        <input type="text" class="form-control" name="name"
                                                            id="name" placeholder="API CallBack Name">
                                                        <span class="messages"></span>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label for="">MyTxid Parameter</label>
                                                        <input type="text" class="form-control" name="name"
                                                            id="name" placeholder="MyTxid Parameter">
                                                        <span class="messages"></span>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label for="">OperatorID Parameter</label>
                                                        <input type="text" class="form-control" name="name"
                                                            id="name" placeholder="OperatorID Parameter">
                                                        <span class="messages"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-4">
                                                        <label for="">Status Parameter</label>
                                                        <input type="text" class="form-control" name="name"
                                                            id="name" placeholder="Status Parameter">
                                                        <span class="messages"></span>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label for="">Success Response</label>
                                                        <input type="text" class="form-control" name="name"
                                                            id="name" placeholder="Success Response">
                                                        <span class="messages"></span>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label for="">Failure Response</label>
                                                        <input type="text" class="form-control" name="name"
                                                            id="name" placeholder="Failure Response">
                                                        <span class="messages"></span>
                                                    </div>
                                                </div>
