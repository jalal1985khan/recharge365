...
array_push($temp_array, array("commAmnt" => $val, "userMobile" => $mnmobile, "name" => $name, "image" => $image, "userType" => $userType, "transID" => $transID, "date" => $date, "time" => $time, "number" => $number, "status" => $status, "OP" => $OP, "amount" => $amount, "remainBal" => $remainBal, "OperatorID" => $operatorID));
  }
} else {
