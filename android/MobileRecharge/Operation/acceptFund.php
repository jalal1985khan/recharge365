    ...
    if($rmoney<=$omoney)
    {
      ...
      if ($SPersonOld_bal=="") {
        echo "Failed";
                        ...
                        mysqli_query($con,"UPDATE `ofline_req` SET `APPROVALSTATUS`='SUCCESS' WHERE USERMOBILE = '$SPersonMobile' AND PERSONID = '$SPersonID' AND ID = '$perfID'");
            ...
            //Update Second person Balance 
             ...
             $transId = rand(889999999,9999999999999999);
