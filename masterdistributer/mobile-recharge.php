...
include("../includes/recharge_action.php");
...
//              $q = $con->query("SELECT * FROM masterdistributer where ID='$ms_id'")->fetch_assoc();
                                                                                            ...
                                                                                            <div class="form-group row mt-3">
                                                                                                <div class="input-group col-sm-6">
                                                                                                      <select onchange="operator_change()" id="operator_menu" name="operator" class="form-control">
                                                                                                        ...
                                                                                                        <?php 
                                                                                                          $query2 = "SELECT * FROM `switchOperator` WHERE `SERVICETYPE`= 'MOBILE'";
