...
if(isset($_POST['distributer'])){
    ...
    if($type == "add"){
        ...
        if($con->query("UPDATE distributer SET RCBAL='$total_amount' WHERE ID='$ms_id'")){
            $admin = $con->query("select * from masterdistributer where ID='$admin_id'")->fetch_assoc();
            $admin_rc = $admin['RCBAL'];
            $ad_am = $admin_rc - $amount;
            if($con->query("UPDATE masterdistributer SET RCBAL='$ad_am' WHERE ID='$admin_id'") && $ad_am > 0){
     ...
     if($type == "deduct"){
        ...
        if($total_amount > 0){
            ...
            $admin_rc = $admin['RCBAL'];
            $ad_am = $admin_rc + $amount;
            if($con->query("UPDATE masterdistributer SET RCBAL='$ad_am' WHERE ID='$admin_id'")){
...
if(isset($_POST['retailer'])){
    ...
    if($type == "add"){
        ...
        if($con->query("UPDATE retailer SET RCBAL='$total_amount' WHERE ID='$ms_id'")){
            ...
            $ad_am = $admin_rc - $amount;
            if($ad_am > 0){
                $con->query("UPDATE masterdistributer SET RCBAL='$ad_am' WHERE ID='$admin_id'");
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Fund Transfer</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="tab-header mt-5">
                                                    <ul class="nav nav-tabs md-tabs tab-timeline justify-content-center" role="tablist"
                                                        id="mytab">
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-toggle="tab" href="#binfo"
                                                                                            ...
                                                                                            <div class="form-group row mt-3">
                                                                                                <div class="input-group col-sm-6">
                                                                                                    <select id="hello-single" name="ds_id" class="form-control stock">
                                                                                                       ...
                                                                                                       $q = $con->query("SELECT * FROM distributer WHERE `MS_ID`='$ms_id' order by ID desc");
                                                                                                ...
                                                                                                <div class="input-group col-sm-6">
                                                                                                    <select id="hello-single" name="rt_id" class="form-control stock">
                                                                                                        <option value="">---- Select Retailer ----</option>
                                                                                                         <?php
                                                                                                         $ms_id = $_SESSION['ms_id'];
                                                                                                       $q = $con->query("SELECT * FROM `retailer` WHERE OWNER='MASTERDISTRIBUTER' and MS_ID='$ms_id' order by ID desc");
                                                                                                       while($row = $q->fetch_assoc()){
