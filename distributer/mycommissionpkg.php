...
session_start();
if(!isset($_SESSION['distributer_id']) || $_SESSION['distributer_id']==="0"){
                                                ...
                                                <div class="table-responsive dt-responsive">
                                                    <table id="custm-tool-ele"
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $id = $_SESSION['ds_id'];
                                                            $q = $con->query("select * from distributer where ID='$id'")->fetch_assoc();
                                                            $cm = $q['COMM_PACK'];
                                                            $q2 = $con->query("select * from operator_comm where PACKAGE_ID='$cm'");
                                                            $i=1;
                                                ...
                                                <div>
                                                    ...
                                                    <div class="input-group">
                                                        <select id="hello-single" class="form-control stock">
                                                            ...
                                                            <option value="married">WhiteLabel</option>
                                                            <option value="unmarried">Master Distributer</option>
                                                            <option value="unmarried">Distributer</option>
                                                            <option value="unmarried">Retailer</option>
                                                        </select>
                                                    </div>
                                                    <h4>Package Name</h4>
                                                    <div class="input-group">
                                                    ...
                                                    <div class="input-group justify-content-center">
                                                        <label class="radio-inline text-center">
                                                            <input type="radio" name="optradio" checked>&nbsp;&nbsp;Activate
                                                        </label>
