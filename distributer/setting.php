    ...
    $error = TRUE;
	    ...
	    if(isset($_POST['save'])){
            ...
            if($con === false){
                ...
                if($new===$confirm){
    	            $query1 = "select * FROM distributer WHERE MOBILE = '".$mobile. "' OR PASSWORD = '".$current. "'";
                                                      ...
                                                      <div class="card-block">
                                                       <div class="container">
                                                        ...
                                                        <form action="" method="post">
                                                            ...
                                                            <input type="submit" class="btn btn-primary waves-effect waves-light m-r-20" value="Save" name="save">
