...
<body>
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Money Transfer</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        <form action="" method="post">
                                                                                            ...
                                                                                            <button type="submit" name="submit_rech" class="btn btn-primary waves-effect waves-light m-r-20">Money Transfer</button>
    ...
    function get_offer(){
        ...
        if(op_code == ""){
            ...
            $.ajax({
                url:'../masterdistributer/offer-handler/mobile_Money Transfer.php',
                type:'post',
