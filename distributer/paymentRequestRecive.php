            ...
            if($user == "RETAILER"){
                    ...
                    if($update){
                         $ds_id = $_SESSION['ds_id'];
                            $query3 = $con->query("SELECT * FROM `distributer` WHERE ID='$ds_id'");
                            ...
                            if($admin_rc_bal > $req_bal){
                                ...
                                if($update2){
                                    ...
                                    $update3 = $con->query("UPDATE `distributer` SET `RCBAL`='$remain_bal' WHERE ID='$ds_id'");
                                    if($update3){
                                                    ...
                                                    <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist"
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-toggle="tab"
                                                                href="#personal" role="tab">Retailer</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                    </ul>
                                                </div>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <table id="simpletable"
                                                                                        ...
                                                                                        <tbody>
                                                                                          <?php 
                                                                                            $ds_id = $_SESSION['ds_id'];
                                                                                            $query = $con->query("SELECT * FROM `amount_req` WHERE OWNER_ID='$ds_id' and PERSON='DISTRIBUTER' and USER='RETAILER' and STATUS='PENDING'");
