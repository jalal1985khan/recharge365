                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    $rt_pn = $con->query("SELECT * FROM recharge_history where DATE='$date' and  (STATUS<>'Success' and STATUS<>' Sucess ') 
                                    ...
                                    $rt_pn_row = $rt_pn->num_rows;
                                     ...
                                     $ds_pn = $con->query("SELECT * FROM recharge_history where DATE='$date' and  (STATUS<>'Success' and STATUS<>' Sucess ') 
                                    ...
                                    $rt_fl = $con->query("SELECT * FROM recharge_history where  DATE='$date' and  (STATUS='Failed' OR STATUS='Failure') 
                                    and OWNER='API_USER' and OWNER_ID='$my_id'");
                                    $rt_fl_row = $rt_fl->num_rows;
                                     while($row3 = $rt_fl->fetch_assoc()){
                                        $rt_fl_am += $row3['AMOUNT'];
                                    }
                                    $ds_fl = $con->query("SELECT * FROM recharge_history where  DATE='$date' and  (STATUS='Failed' OR STATUS='Failure') 
                                                    ...
                                                    <table id="custm-tool-ele"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if(isset($_POST['filter_date'])){
                                                                ...
                                                                $my_id = $_SESSION['ap_id'];
                                                          $q2 = $con->query("SELECT * FROM recharge_history where  (DATE BETWEEN '$date1' AND '$date2')  and PERSON='API_USER' and PERSON_ID='$my_id'");
                                                            $i =1 ;
                                                         ...
                                                         <!--//display my record -->
                                                         <?php
                                                          $q2 = $con->query("SELECT * FROM recharge_history where DATE='$date' and PERSON='API_USER' and PERSON_ID='$my_id'");
                                                            $i =1 ;
                                                            while($row = $q2->fetch_assoc()){
                                                            ?>
                                                            <tr>
