...
if(isset($_GET['req_accept'])){
    ...
    if($status == "PENDING"){
             if($user == "DISTRIBUTER"){
                    ...
                    if($update){
                         $admin_id = $_SESSION['ms_id'];
                            $query3 = $con->query("SELECT * FROM `masterdistributer` WHERE ID='$admin_id'");
                            $admin_row = $query3->fetch_assoc();
                            $admin_rc_bal = $admin_row['RCBAL'];
                            if($admin_rc_bal > $req_bal){
                                $update2 = $con->query("UPDATE `amount_req` SET `STATUS`='ACCEPTED' WHERE ID='$req_id'");
                                if($update2){
                                    $remain_bal = $admin_rc_bal -$req_bal;
                                    $update3 = $con->query("UPDATE `masterdistributer` SET `RCBAL`='$remain_bal' WHERE ID='$admin_id'");
                                    if($update3){
                                    echo "<script>alert('Request Accepted');
                                        location.replace('paymentRequestRecive.php')
                                    </script>";
                                    }//update3
                                 }//update2
                            }else{
                    ...
                    $user_rc_bal = $user_row['RCBAL'];
                    $add_bal = $user_rc_bal + $req_bal;
                    $update = $con->query("UPDATE `retailer` SET `RCBAL`='$add_bal'");
                    if($update){
                                                    ...
                                                    <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist"
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-toggle="tab"
                                                                href="#personal" role="tab">Distributer</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                        <li class="nav-item">
                                                                                    ...
                                                                                    <table id="simpletable"
                                                                                        ...
                                                                                        <tbody>
                                                                                          <?php 
                                                                                            ...
                                                                                            $query = $con->query("SELECT * FROM `amount_req` WHERE OWNER_ID='$ms_id' and PERSON='MASTERDISTRIBUTER' and USER='DISTRIBUTER'");
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td><a href="paymentRequestRecive.php?req_accept&id=<?php echo $array["ID"]; ?>" type="button" class="  btn btn-primary">Accept</a>
                                                                                                <br><br> <a href="paymentRequestRecive.php?req_reject&id=<?php echo $array["ID"]; ?>" type="button" class="  btn btn-primary">Reject</a></td>                                                                                            </tr>
                                                                                          <?php } ?>
                                                                                        </tbody>
                                                                                        <!--<tfoot>-->
                                                                                        <!--    <tr>-->
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <table id="simpletable"
                                                                                        ...
                                                                                        <tbody>
                                                                                            <?php 
                                                                                            $ms_id = $_SESSION['ms_id'];
                                                                                            $query = $con->query("SELECT * FROM `amount_req` WHERE OWNER_ID='$ms_id' and PERSON='MASTERDISTRIBUTER' and USER='RETAILER'");
                                                                                            while ($array = $query->fetch_assoc()){?>
                                                                                            <tr>
                                                                                                <td><?php echo $array["ID"]; ?></td>
                                                                                                <td><?php echo $array["TYPE"]; ?></td>
