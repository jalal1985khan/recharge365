...
if(isset($_POST['update'])){
 ...
 //   $id = $_SESSION['ap_id'];
  ...
  //  $img_name = $img['name'];
   ...
   // $dest = "img/".$img_name;
   // if($con->query("UPDATE Api_users SET NAME='$name' , ADDRESS='$address' , STATE='$state' , CITY='$city' where ID='$id'")){
         ...
         //  $user = $con->query("select * from Api_users where ID='$id'")->fetch_assoc();
          ...
          //  $old_dest = "img/".$old_img;
           ...
           // if($old_img != "" && $old_img != "default.jpeg" && $default_img != $old_dest){
                 ...
                 //   $con->query("UPDATE Api_users SET IMAGE='$img_name' where ID='$id'");
