...
.v-bal{
 ...
 <!--       <div class="col-9 col-md-10">-->
            <?php 
            // $news = $con->query("select * from news_alert where TYPE='APIUSER'")->fetch_assoc();
            ?>
                ...
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <a style="font-size:18px; font-weight:700" href="index.php">
                             <img class="img-fluid" src="../../images/<?php echo $row2['LOGO']; ?>" width="150" alt="Company Logo" /> 
                        </a>
                    ...
                    <div class="navbar-container container-fluid">
                        <div>
                            ...
                            <li class="header-notification">
                                ...
                                <!--<input type="text" value=" <?php echo $row['RCBAL'];?>"-->
                            </li>
                            <li class="header-notification">
                                <a href="#!" class="displayChatbox v-bal">
                                    DMR BAl: <?php 
