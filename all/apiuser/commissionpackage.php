                                                           ...
                                                           $ms_id = $_SESSION['ms_id'];
                                                            ...
                                                            if($res->num_rows > 0){
                                                                while($row = $res->fetch_assoc()){
                                                                    ...
                                                                    <td>'.$row['USERTYPE'].'</td>
                                                                    <td>'.$row['STATUS'].'</td>
                                                                    <td><a href="api-commission.php?editpack&id='.$row['ID'].'&name='.$row['PACKNAME'].'" class="text-center text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a></td>
                                                                   <td>
