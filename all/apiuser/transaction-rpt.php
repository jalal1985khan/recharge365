                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        ...
                                        $date = date("Y-m-d");
                                        $success = $con->query("SELECT * FROM amount_req where DATE='$date' and  USER='API_USER'  and  USER_ID='$my_id' and  STATUS='ACCEPTED'   order by ID DESC")->num_rows;
                                        $failed = $con->query("SELECT * FROM amount_req where DATE='$date' and  USER='API_USER'   and  USER_ID='$my_id' and  STATUS='REJECTED'  order by ID DESC")->num_rows;
                                        $pending = $con->query("SELECT * FROM amount_req where DATE='$date' and  USER='API_USER'  and  USER_ID='$my_id' and  STATUS='PENDING' order by ID DESC")->num_rows;
                                        ?>
                                        <div class="row">
                                                    ...
                                                    <table id="custm-tool-ele"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if(isset($_POST['filter_date'])){
                                                                ...
                                                                $date2 = $_POST['date2'];
                                                                $my_id = $_SESSION['ap_id'];
                                                            $q = $con->query("SELECT * FROM amount_req where USER='API_USER' and USER_ID='$my_id' and (DATE BETWEEN '$date1' and '$date2') order by ID DESC");
                                                        ...
                                                        ?>
                                                            ...
                                                            $my_id = $_SESSION['ap_id'];
                                                            $date = date("Y-m-d");
                                                            $q = $con->query("SELECT * FROM amount_req where  USER='API_USER' and USER_ID='$my_id' and DATE='$date' order by ID DESC");
                                                            while($row = $q->fetch_assoc()){
                                                                $i = 1;
                                                            ?>
                                                            <tr>
