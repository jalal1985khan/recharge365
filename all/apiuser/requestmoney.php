...
if(isset($_POST['request'])){
    ...
    $dest = "../images/amount_req/api_user/".$img_name;
    ...
    ( 'ADMIN','API_USER' , '1', '$ms_id' , '$type' , '$mode' , '$amt' , '$utr' , '$acc' , '$img_name' , '$date' , 'PENDING')");
    if($query2){
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="tab-content">
                                                 ...
                                                 <div class="tab-pane" id="binfo" role="tabpanel">
                                                        ...
                                                        $q = $con->query("SELECT * FROM `Api_users` where ID='$my_id'");
                                                        $row = $q->fetch_assoc();
                                                                                        ...
                                                                                        <form name="razorpay_frm_payment" class="razorpay-frm-payment" id="razorpay-frm-payment" method="post">
                                                                                            <div class="form-group row mt-3">
                                                                                                <div class="col-sm-12">
                                                                                                    ...
                                                                                                    <input type="hidden" name="billing-phone" id="billing-email" value="<?php echo $row['EMAIL']?>">
                                                                                                    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
                                                                                                    <input type="hidden" name="surl" id="surl" value="Payment/success.php">
                                                                                                    <input type="hidden" name="furl" id="furl" value="Payment/failed.php">
                                                                                            ...
                                                                                            <div class="text-center">
                                                                                            <button type="button" id="razor-pay-now" class="btn btn-primary waves-effect waves-light m-r-20">Add Wallet</button>
                                                                                            <a href="#!" id="edit-cancel" class="btn btn-default waves-effect">Cancel</a>
                                                                                        </div>
                                                                                        </form> 
                                                                                    </div>
...
<script type="text/javascript">
  jQuery(document).on('click', '#razor-pay-now', function (e) {
    ...
    var store_name = 'Recharge Webspidy';
    var store_description = 'Recharge Now';
    var store_logo = '../images/icon.png';
