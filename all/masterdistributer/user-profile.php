...
if(isset($_POST['update'])){
    ...
    $dest = "img/".$img_name;
    if($con->query("UPDATE masterdistributer SET NAME='$name' , ADDRESS='$address' , STATE='$state' , CITY='$city' where ID='$id'")){
        ...
        if(!empty($img_name) && $img_name != ""){
            ...
            if($old_img != "" && $old_img != "default.jpeg" && $default_img != $old_dest){
                    ...
                    $con->query("UPDATE masterdistributer SET IMAGE='$img_name' where ID='$id'");
