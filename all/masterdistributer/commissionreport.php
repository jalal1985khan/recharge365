                                                ...
                                                <div class="table-responsive dt-responsive">
                                                    <table id="custm-tool-ele"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $query = $con->query("select * from comm_rpt where TYPE='MASTERDISTRIBUTER' and USER_ID='$my_id' and (DATE BETWEEN '$date1' AND '$date2')");
                                                    ...
                                                    <?php } }else{
                                                                $date = date("Y-m-d");
                                                               $my_id = $_SESSION['ms_id'];
                                                            $query = $con->query("select * from comm_rpt where TYPE='MASTERDISTRIBUTER' and USER_ID='$my_id' and DATE='$date'");
                                                            while($row = $query->fetch_assoc()){
                                                            ?>
                                                            <tr>
                                                                <td><?php echo $row['ID'] ?></td>
