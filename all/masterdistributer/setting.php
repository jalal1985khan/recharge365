...
$headers = 'From: supportrecharges365.com' . "\r\n" .
    ...
    $error = TRUE;
	    ...
	    if(isset($_POST['save'])){
            ...
            if($con === false){
                ...
                if($new===$confirm){
    	            $query1 = "select * FROM admin WHERE MOBILE = '".$mobile. "' OR PASSWORD = '".$current. "'";
    	            ...
    	            print_r($row);
   	                if($row != 0){
    		            ...
    		            $query2 ="UPDATE admin SET PASSWORD='".$new."' WHERE MOBILE='".$mobile."'";
     		            $run_query = mysqli_query($con , $query2 );
     		            print_r($run_query);
     		            $message1 = "Dear%20User%20Your%20Password%20is%20$password%20from%www.recharges365.com";
     		            $message2 = "Dear User Your Password is $password from www.recharges365.com";
   		                ...
   		                header("location:../masterdistributer/");
