...
// $headers = 'From: barbhuiya785@gmail.com' . "\r\n" .
//   'Reply-To:  barbhuiya785@gmail.com' . "\r\n" .
...
if(isset($_POST['submitdistributers'] )){
    ...
    $password = mt_rand(100000 , 900000);
 	$message = "Dear%20Distributor%2C%20Your%20Password%20for%20vpmultirecharge%20is%20$password.%20By%20www.recharges365.com";
 	$message2 = "Dear Distributor, Your Password for online Vpmultirecharge is $password. By www.rechargges365.com";
                                                ...
                                                <div class="table-responsive dt-responsive">
                                                    <table id="custm-tool-ele"
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $ms_id = $_SESSION['ms_id'];
                                                $res = $con->query("SELECT * FROM distributer WHERE  OWNER='MASTERDISTRIBUTER' and `MS_ID`='$ms_id' order by ID asc");
                                                if($res->num_rows > 0){
