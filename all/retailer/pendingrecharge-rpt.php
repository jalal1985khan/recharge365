                                    ...
                                    <div class="page-body">
                                            ...
                                            <div class="card-header">
                                                ...
                                                <button type="button"
                                                            ...
                                                            data-modal="modal-13"> <i
                                                                class="icofont icofont-plus m-r-5"></i>On Action
                                                </button>
                                            </div>
                                            <div class="card-block">
                                        ...
                                        <div class="md-modal md-effect-13 addcontact" id="modal-13">
                                            <div class="md-content">
                                                <h3 class="f-26">Pending Recharge</h3>
                                                <h3 class="f-26">Recharge TXN No : 565658</h3>
                                                <div>
                                                    ...
                                                    <div class="input-group">
                                                        <select id="hello-single" class="form-control stock">
                                                            ...
                                                            <option value="unmarried">success</option>
                                                        </select>
                                                    </div>
                                                    <h5>Confirm Operator ID</h5>
                                                    <div class="input-group">
