...
<body>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        <form action="" method="post">
                                                                                            ...
                                                                                            <button type="submit" name="submit_rech" class="btn btn-primary waves-effect waves-light m-r-20">Pay Bill</button>
    ...
    function get_offer(){
        var el_code = document.getElementById("op_code").value;
        ...
        document.getElementById("roff").innerHTML= "Loading... Please Wait."
            $.ajax({
                url:'../masterdistributer/offer-handler/mobile_recharge.php',
                type:'post',
                data:{el_code:el_code, number:number},
                success:function(data , status){
