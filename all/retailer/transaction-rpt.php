                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        ...
                                        $success = $con->query("SELECT * FROM amount_req where USER='RETAILER' and USER_ID='$my_id'and  STATUS='ACCEPTED'   order by ID DESC")->num_rows;
                                        $failed = $con->query("SELECT * FROM amount_req where USER='RETAILER' and USER_ID='$my_id'and  STATUS='REJECTED'  order by ID DESC")->num_rows;
                                        $pending = $con->query("SELECT * FROM amount_req where USER='RETAILER' and USER_ID='$my_id'and  STATUS='PENDING' order by ID DESC")->num_rows;
                                        ?>
                                        <div class="row">
                                                    ...
                                                    <table id="custm-tool-ele"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if(isset($_POST['filter_date'])){
                                                                ...
                                                                $date2 = $_POST['date2'];
                                                                $my_id = $_SESSION['rt_id'];
                                                            $q = $con->query("SELECT * FROM amount_req where USER='RETAILER' and USER_ID='$my_id' and (DATE BETWEEN '$date1' AND '$date2') order by ID DESC");
                                                        ...
                                                        ?>
                                                            ...
                                                            $my_id = $_SESSION['rt_id'];
                                                            $date = date("Y-m-d");
                                                            $q = $con->query("SELECT * FROM amount_req where USER='RETAILER' and USER_ID='$my_id' and DATE='$date' order by ID DESC");
                                                            while($row = $q->fetch_assoc()){
                                                                $i = 1;
                                                            ?>
                                                            <tr>
