                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    $ds_sc = $con->query("SELECT * FROM recharge_history where DATE='$date' and  (STATUS='Success' OR STATUS=' Sucess ') and 
                                     PERSON='DISTRIBUTER' and PERSON_ID='$my_id'");
                                    ...
                                    and STATUS<>'Failed' and STATUS<>'Failure' and OWNER='DISTRIBUTER' and OWNER_ID='$my_id' and (PERSON='RETAILER' OR PERSON='retailer')");
                                    ...
                                    and STATUS<>'Failed' and STATUS<>'Failure' and  PERSON='DISTRIBUTER' and PERSON_ID='$my_id'");
                                    ...
                                    and OWNER='DISTRIBUTER' and OWNER='DISTRIBUTER' and OWNER_ID='$my_id' and (PERSON='RETAILER' OR PERSON='retailer')");
                                    ...
                                    and PERSON='DISTRIBUTER' and PERSON_ID='$my_id'");
                                                    ...
                                                    <table id="custm-tool-ele"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if(isset($_POST['filter_date'])){
                                                                ...
                                                                $my_id = $_SESSION['ds_id'];
                                                          $q = $con->query("SELECT * FROM recharge_history where  (DATE BETWEEN '$date1' AND '$date2')  and OWNER='DISTRIBUTER'  and OWNER_ID='$my_id' and (PERSON='retailer' or PERSON='RETAILER')");
                                                                $i =1 ;
                                                         ...
                                                         <!--//display my record -->
                                                         <?php
                                                          $q2 = $con->query("SELECT * FROM recharge_history where  (DATE BETWEEN '$date1' AND '$date2')  and PERSON='DISTRIBUTER' and OWNER_ID='$my_id' and PERSON_ID='$my_id'");
                                                            $i =1 ;
                                                            ...
                                                            <tr>
                                                                <td><?php echo $i++ ?></td>
                                                                    <?php
                                                                      $person = $con->query("select * from distributer where ID='$my_id'")->fetch_assoc();
                                                         ...
                                                         <?php } }else{
                                                                $my_id = $_SESSION['ds_id'];
                                                                 $date = date("Y-m-d");
                                                                $q = $con->query("SELECT * FROM recharge_history where DATE='$date' and OWNER='DISTRIBUTER' and (PERSON='retailer' or PERSON='RETAILER')");
                                                                $i =1 ;
                                                                while($row = $q->fetch_assoc()){
                                                                ?>
                                                                <tr>
                                                         ...
                                                         <!--//display my record -->
                                                         <?php
                                                          $q2 = $con->query("SELECT * FROM recharge_history where DATE='$date' and PERSON='DISTRIBUTER' and PERSON_ID='$my_id'");
                                                            $i =1 ;
                                                            while($row = $q2->fetch_assoc()){
                                                            ?>
                                                            <tr>
