...
error_reporting(0);
$row=$_SESSION["row"];
if(!isset($_SESSION["distributer_status"]) || $_SESSION["distibuter_status"]==="0"){
...
if(isset($_POST['request'])){
  ...
  $rid=$row["NAME"];
    ...
    $query = $con->query("SELECT * FROM `distributer` WHERE ID='$ds_id'");
    ...
    ( '$owner', 'DISTRIBUTER' , '$ms_id', '$ds_id' , '$type' , '$mode' , '$amt' , '$utr' , '$acc' , '$img_name' , 'PENDING' , '$date')");
    if($query2){
