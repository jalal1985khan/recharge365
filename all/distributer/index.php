<?php
session_start();
if(isset($_GET['login_ds'])){
	$user_id = $_GET['id'];
	$_SESSION['ds_id'] = $user_id;
	$_SESSION["distributer_status"] = $user_id;
	}
                                                    ...
                                                    <table id="custm-tool-ele"
                                                     ...
                                                     <thead>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $date = date("Y-m-d");
                                                            $q = $con->query("SELECT * FROM recharge_history where DATE='$date' and OWNER='DISTRIBUTER' and OWNER_ID='$my_id' and (PERSON='retailer' or PERSON='RETAILER')");
                                                            $i =1 ;
