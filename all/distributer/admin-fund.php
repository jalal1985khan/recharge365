                                                                                        ...
                                                                                        <form method="post">
                                                                                            <div class="form-group row mt-3">
                                                                                                <div class="input-group col-sm-6">
                                                                                                    <select id="hello-single" name="" class="form-control stock">
                                                                                                        <option value="">---- Select Retailer ----</option>
                                                                                              <?php
                                                                                              $my_id = $_SESSION['ds_id'];
                                                                                              $user = $con->query("select * from retailer where OWNER='DISTRIBUTER' and DISTRIBUTER='$my_id'");
                                                                                            ...
                                                                                            <button type="button" class="btn btn-primary waves-effect waves-light m-r-20">SUBMIT</button>
