                                                ...
                                                <div class="table-responsive dt-responsive">
                                                    <table id="custm-tool-ele"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $query = $con->query("select * from comm_rpt where TYPE='DISTRIBUTER' and USER_ID='$my_id' and (DATE BETWEEN '$date1' AND '$date2') order by ID ASC ");
                                                            ...
                                                            <?php
                                                                   ...
                                                                   $date = date("Y-m-d");
                                                                $my_id = $_SESSION['ds_id'];
                                                            $q = $con->query("select * from comm_rpt where TYPE='DISTRIBUTER' and USER_ID='$my_id' and DATE='$date'  order by ID ASC");
                                                            $i =1 ;
